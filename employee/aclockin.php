...
$desc="Worked for 8hrs";
 if ($workSTSt>=28800) {
                ...
                $response['error']=false;
                $response['message']="Error: Sorry $empname You cannot clock out now you have worked less than 8hrs.";
             }
                ...
                $response['error']=false;
                $response['message']="Error: Sorry $empname you never clocked in today.";
}
               	...
               	// code...
               	$response['error']=false;
        		$response['message']="Error: Sorry your ID is not registered";
               }
