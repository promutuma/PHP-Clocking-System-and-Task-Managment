...
<?
     ...
     $sql="SELECT * FROM `receptionist` WHERE resetcode = ? ";
...
<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			<div class="col-md-4 text-center company__info">
				...
				<h4 class="company_title">CETRAD</h4><hr><small>Human Resource Portal Reset Password</small>
			</div>
...
<div class="mb-3">
  ...
  <div class="row">
								<input type="submit"  value="Update Password" name="REReset" class="btno">
							</div>
						</form>
					</div>
					<div class="row">
