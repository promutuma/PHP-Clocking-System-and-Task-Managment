...
<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			<div class="col-md-4 text-center company__info">
				...
				<h4 class="company_title">CETRAD</h4><hr><small>Employee Portal <br> (used by receptionist only)</small>
			</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<form control="" class="form-group" method="POST" action="../files/include.php">
							...
							<div class="row">
								<input type="submit" name="reclogin" value="Submit" class="btno">
							</div>
						</form>
					</div>
					<div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="REreset" class="btn btn-primary">Reset Your Password</button>
        </form>
      </div>
    </div>
  </div>
