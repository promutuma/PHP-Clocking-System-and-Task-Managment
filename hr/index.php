...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Human Resource Portal</li>
  </ol>
</nav>
 </div>   
...
<?php
	echo "<i class=\"bi bi-person\"></i> | ".$_SESSION['human'] . "<br>";
?>
</div>
    <?php
      require 'hrnav.php';?>
    ...
    <div class="col-sm-10 text-left"> 
      <h1><?php
	echo "<i class=\"bi bi-person\"></i> | ".$_SESSION['human'] . "<br>";?></h1>
 <?php
